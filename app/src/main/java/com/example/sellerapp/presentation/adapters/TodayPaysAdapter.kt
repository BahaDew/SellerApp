...
import com.example.sellerapp.databinding.ItemTodayPaysBinding
import java.text.NumberFormat
import java.text.SimpleDateFormat
import java.util.Locale

class TodayPaysAdapter : ListAdapter<TodayPaysData, TodayPaysAdapter.MyHolder>(MyDiffUtil) {
    private var listenerOnClick : ((TodayPaysData) -> Unit)? = null
    private var onClickEdit : ((TodayPaysData) -> Unit)? = null
    inner class MyHolder(private val binding: ItemTodayPaysBinding) : ViewHolder(binding.root) {
        init {
